...
class ProcessMockup extends Process
{
    ...
    public function getOutput()
    {
        ...
        if ($this->commandline == 'git diff dc48f19b265150c4cc584cf6c0726d7cb78cef17 532a3146b07ea9eeeaf979e8b0228c4d0d4895d3 --name-status' || $this->commandline == 'git diff LASTCOMMITHASH HEAD --name-status') {
